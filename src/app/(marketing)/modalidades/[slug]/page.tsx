        ...
        {modalidade.imagem_url ? (
          <div className="absolute inset-0">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0C2418] via-[#0C2418]/65 to-[#0C2418]/25" />
          </div>
        ) : (
        ...
        <div className="relative z-10 w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-14 pt-36">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-[5.5rem] font-black tracking-tight text-white leading-[0.88] mb-6">
                {modalidade.nome}
              </h1>
              {modalidade.descricao && (
                <p className="text-lg sm:text-xl text-white/72 leading-relaxed max-w-2xl font-light">
                  {modalidade.descricao}
                </p>
              )}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-2 space-y-20">
            ...
            {hasAbout && (
              <section aria-labelledby="sobre-heading">
                ...
                <div className="text-white/62 leading-relaxed whitespace-pre-wrap text-base sm:text-lg">
            ...
            <section aria-labelledby="para-quem-heading">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  >
                    <h3 className="text-sm font-bold text-white/85 mb-2">{item.label}</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  {professores.map((prof) => (
                    <Link
                      ...
                      className="group flex gap-4 rounded-xl border border-white/12 bg-[#123020]/30 p-6 hover:border-white/28 transition-all duration-300"
                    >
                      {/* Avatar */}
                      {prof.pessoa.foto_url ? (
                        ...
                        <div className="flex-none size-12 rounded-full bg-white/8 border border-white/18 flex items-center justify-center shrink-0">
                          <span className="text-base font-bold text-white/62">
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="font-bold text-white group-hover:text-white leading-tight truncate transition-colors">
                        ...
                        {prof.bio && (
                          <p className="text-sm text-white/45 mt-2 leading-relaxed line-clamp-3">
                            {prof.bio}
                          </p>
                        )}
                        {prof.especialidades && prof.especialidades.length > 0 && (
                          <div className="mt-3 flex flex-wrap gap-1.5">
                            {prof.especialidades.slice(0, 3).map((esp) => (
                              <span
                                key={esp}
                                className="inline-flex rounded-full bg-white/8 border border-white/18/80 px-2.5 py-0.5 text-[10px] font-medium text-white/62"
                              >
                                {esp}
                              </span>
                            ))}
                        ...
                        <span className="mt-3 block text-[11px] font-medium text-white/30 group-hover:text-white/62 transition-colors">
                          Ver perfil →
                        </span>
                      </div>
                    </Link>
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-white/18/80 bg-[#123020] p-7 lg:sticky lg:top-8">
              <h2 className="text-lg font-bold text-white mb-1.5">Pronto para começar?</h2>
                  ...
                  {turmas.map((turma) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2 mb-2">
                        <h3 className="text-xs font-bold text-white/85 leading-snug">
                          {turma.nome}
                        </h3>
                      ...
                      {turma.dia_semana && turma.dia_semana.length > 0 && (
                        <p className="text-[11px] text-white/45 mb-1 font-medium">
                          {[...turma.dia_semana]
                            .sort((a, b) => a - b)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
            <div>
              ...
              <h2 className="text-2xl font-bold text-white">Comece hoje. Evolua sempre.</h2>
