    ...
    <>
      ...
      <section className="relative overflow-hidden bg-surface-dark py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="mb-3 text-xs font-semibold uppercase tracking-[0.25em] text-[var(--text-on-dark-muted)]">
              Apresentações
            </p>
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Conheça o GŌKAI a fundo
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-base text-[var(--text-on-dark-secondary)]">
          ...
          <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                color: "text-[var(--text-on-dark-secondary)]",
              },
              {
                icon: UserPlus,
              ...
              <Link
                key={card.title}
                href={card.href}
                className="group relative flex flex-col gap-5 rounded-xl border border-white/12 bg-white/5 p-8 transition-all hover:border-white/28 hover:bg-surface-dark-alt"
              >
                <card.icon className={`size-8 ${card.color} transition-colors group-hover:text-red-500`} />
                <div>
                  <h3 className="text-lg font-semibold text-white">{card.title}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-[var(--text-on-dark-muted)]">{card.desc}</p>
                </div>
                <div className="mt-auto flex items-center gap-2 text-sm font-medium text-[var(--text-on-dark-secondary)] transition-colors group-hover:text-[var(--text-on-dark)]">
                  Abrir apresentação
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
          <p className="mb-8 text-xs font-semibold uppercase tracking-[0.35em] text-[var(--text-on-dark-muted)]">
            Apresentação Institucional
          </p>
          <h1 className="text-5xl font-bold leading-[1.05] tracking-tight text-white sm:text-7xl lg:text-8xl">
            GŌKAI
          </h1>
          <p className="mt-2 text-lg font-medium tracking-widest text-[var(--text-on-dark-secondary)] sm:text-xl">
          ...
          <p className="mx-auto max-w-xl text-base font-medium italic leading-relaxed text-[var(--text-on-dark-muted)]">
            &ldquo;A disciplina constrói o caminho. A evolução é o destino.&rdquo;
          </p>
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-[var(--text-on-dark-secondary)]">
          ...
          <div className="mt-12">
            <a
              href="#quem-somos"
              className="inline-flex items-center gap-2 text-sm font-medium text-[var(--text-on-dark-secondary)] transition-colors hover:text-[var(--text-on-dark)]"
            >
      ...
      <section
        id="quem-somos"
        className="relative overflow-hidden bg-surface-dark-alt py-28"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <div className="mt-8 space-y-4 text-base leading-relaxed text-[var(--text-on-dark-secondary)]">
                <p>
                  O <strong className="text-[var(--text-on-dark)]">GŌKAI</strong> é uma associação dedicada à
                ...
                <p className="text-[var(--text-on-dark-secondary)] font-medium">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={v.title}
                  className="flex flex-col gap-3 rounded-xl border border-white/12 bg-surface-dark/50 p-5 transition-colors hover:border-white/28"
                >
                  <v.icon className="size-6 text-[var(--text-on-dark-secondary)]" />
                  <h3 className="text-sm font-semibold text-white">{v.title}</h3>
                  <p className="text-xs leading-relaxed text-[var(--text-on-dark-muted)]">{v.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ════════════════════════════════════════════════════════════════════════
          SLIDE 3 — NÚMEROS
      ════════════════════════════════════════════════════════════════════════ */}
      <section className="relative bg-surface-dark py-28 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-6">
            {[
              ...
              <div
                key={stat.label}
                className="flex flex-col items-center gap-3 rounded-xl border border-white/12/60 bg-surface-dark-alt/40 p-6 text-center"
              >
                <stat.icon className="size-5 text-[var(--text-on-dark-muted)]" />
                <span className="text-3xl font-bold text-white sm:text-4xl">
                  {stat.value}
                </span>
                <span className="text-xs font-medium text-[var(--text-on-dark-muted)]">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      ════════════════════════════════════════════════════════════════════════ */}
      <section className="bg-surface-dark-alt py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="mb-3 text-xs font-semibold uppercase tracking-[0.25em] text-[var(--text-on-dark-muted)]">
              Estrutura
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={item.title}
                className="flex gap-4 rounded-xl border border-white/12 bg-surface-dark/50 p-6"
              >
                <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-white/8">
                  <item.icon className="size-5 text-[var(--text-on-dark-secondary)]" />
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-white">{item.title}</h3>
                  <p className="mt-1.5 text-xs leading-relaxed text-[var(--text-on-dark-muted)]">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
              ...
              <div className="mt-10 space-y-6">
                {[
                  ...
                  <div key={item.title} className="flex gap-4">
                    <div className="flex size-8 shrink-0 items-center justify-center rounded-full border border-white/18 bg-white/8 text-xs font-bold text-[var(--text-on-dark-secondary)]">
                      {i + 1}
                    </div>
                    <div>
                      <h3 className="text-sm font-semibold text-white">{item.title}</h3>
                      <p className="mt-1 text-sm leading-relaxed text-[var(--text-on-dark-muted)]">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="rounded-2xl border border-white/12 bg-surface-dark-alt p-8 lg:p-10">
                <Quote className="mb-4 size-8 text-[var(--text-on-dark-muted)]" />
                <blockquote className="text-lg font-medium leading-relaxed text-[var(--text-on-dark-secondary)] italic">
                ...
                <div className="mt-6 flex items-center gap-3">
                  <div className="flex size-10 items-center justify-center rounded-full bg-white/8 text-sm font-bold text-[var(--text-on-dark-secondary)]">
                    P
                  </div>
                  <div>
                    <p className="text-sm font-medium text-[var(--text-on-dark)]">Parceiro GŌKAI</p>
                    <p className="text-xs text-[var(--text-on-dark-muted)]">Apoiador desde 2024</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-surface-dark-alt py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <TierCard
              nivel="Ouro"
              badgeClass="bg-secondary text-surface-dark"
              ringClass="ring-2 ring-secondary/40"
              featured
              benefits={[
            ...
            <TierCard
              nivel="Prata"
              badgeClass="bg-white/80 text-surface-dark"
            ...
            <TierCard
              nivel="Apoiador"
              badgeClass="bg-white/12 text-[var(--text-on-dark-secondary)]"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 flex flex-wrap items-center justify-center gap-8">
              {patrocinadores.map((p) => (
                <div
                  key={p.id}
                  className="group flex h-20 w-40 items-center justify-center rounded-xl border border-white/12 bg-surface-dark-alt/60 p-4 transition-all hover:border-white/28"
                  title={p.nome}
                >
                  {p.logo_url ? (
                    ...
                    <span className="text-center text-xs font-medium text-[var(--text-on-dark-muted)] transition-colors group-hover:text-[var(--text-on-dark-secondary)]">
                      {p.nome}
                    </span>
                  )}
                </div>
      ...
      {/* ════════════════════════════════════════════════════════════════════════
          SLIDE 8 — CTA FINAL
      ════════════════════════════════════════════════════════════════════════ */}
      <section className="relative overflow-hidden bg-surface-dark-alt py-32">
        <div
          className="pointer-events-none absolute inset-0"
          style={{
            background:
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6">
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.25em] text-[var(--text-on-dark-muted)]">
            Próximo passo
          </p>
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-5xl">
            Vamos conversar?
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-[var(--text-on-dark-secondary)]">
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/contato"
              className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-secondary px-8 text-sm font-semibold text-surface-dark shadow-lg shadow-secondary/20 transition-all hover:bg-red-500 hover:shadow-red-500/30 active:scale-[0.98]"
            >
            ...
            <Link
              ...
              className="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-white/18 px-8 text-sm font-medium text-[var(--text-on-dark-secondary)] transition-all hover:border-white/35 hover:text-white active:scale-[0.98]"
            >
              Ver planos detalhados
            </Link>
          </div>

          <p className="mt-10 text-xs text-[var(--text-on-dark-muted)]">
...
function TierCard({
  ...
  return (
    <div
      className={`relative flex flex-col rounded-xl bg-surface-dark/50 p-6 ${ringClass} ${
        featured ? "lg:-mt-4 lg:mb-4 lg:shadow-lg lg:shadow-red-600/5" : ""
      }`}
    >
      {featured && (
        <div className="absolute -top-3 left-6">
          <span className="rounded-full bg-secondary px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-surface-dark">
            Recomendado
          </span>
        </div>
      )}
      ...
      <ul className="flex-1 space-y-2.5">
        {benefits.map((b) => (
          <li key={b} className="flex items-start gap-2 text-sm text-[var(--text-on-dark-secondary)]">
            <CheckCircle2 className="mt-0.5 size-3.5 shrink-0 text-[var(--text-on-dark-muted)]" />
            <span>{b}</span>
          </li>
        ))}
      </ul>
